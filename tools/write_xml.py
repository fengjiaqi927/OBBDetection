...
if __name__ == '__main__':
    ...
    parser.add_argument("--json_path", help="input file", type=str,
                        default='/home/liyan/Projects/OBBDetection/output_path/ISPRS_obb_r101_3s_dcn_48e/results_final.json')
    parser.add_argument("--xml_path", help="output path", type=str, default='test/')
    parser.add_argument("--img_path", help="image path", type=str, default='/home/liyan/FAIR1M/test/images/')
    ...
    os.system('zip -r test20220222.zip test/')
